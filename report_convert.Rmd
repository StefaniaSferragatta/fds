...
<img src="imgs/features_all.png" width="700"/>
2. Random selection: randomly select some of the features 
<img src="imgs/features_random.png" width="700"/>
...
<img src="imgs/features_corr.png" width="700"/>
...
<img src="imgs/lr_cm.png" width="300"/>
<img src="imgs/lr_hp.png" width="300"/>
<img src="imgs/lr_roc.png" width="300"/>
...
<img src="imgs/knn_cm.png" width="300"/>
<img src="imgs/knn_hp.png" width="300"/>
<img src="imgs/knn_roc.png" width="300"/>
...
We are implementing decision tree in daily life, We take into consideration of criteria then go take some decision.
The Decision tree mentioned below is simple example in daily life and we have conclusion from tree that if we go out without mask then there are chances to be infected by covid19.

<img src ="imgs/Sample_descision_tree.PNG" >

So how to made decision tree ? We can follow these steps to make it happen
...
In this method we tuned the parameters by GridsearchCv from sklearn, You can see from the figure decision tree that has been created.

<img src ="imgs/Descison_Tree.png" width="800"/>

#### Evaluation 
Here we report the results obtained for this algorithm in the original version of the analysis, when the hyperparameters were not optimized. For this evaluation we will use the methods defined in the section "Evaluation of the classification models".

<img src="imgs/tclass_cm.png" width="300"/>
<img src="imgs/tclass_hp.png" width="300"/>
<img src="imgs/tclass_roc.png" width="300"/>
...
<img src="imgs/rforest_cm.png" width="300"/>
<img src="imgs/rforest_hp.png" width="300"/>
<img src="imgs/rforest_roc.png" width="300"/>
...
<img src="imgs/bagging.svg" width="700"/>
...
<img src="imgs/bagg_cm.png" width="300"/>
<img src="imgs/bagg_hp.png" width="300"/>
<img src="imgs/bagg_roc.png" width="300"/>
...
<img src="imgs/accuracy_score.jpg">
...
<img src="imgs/boost_algo.png" width="800"/>


#### Evaluation
Here we report the results obtained for this algorithm in the original version of the analysis, when the hyperparameters were not optimized. For this evaluation we will use the methods defined in the section "Evaluation of the classification models".

<img src="imgs/boost_cm.png" width="300"/>
<img src="imgs/boost_hp.png" width="300"/>
<img src="imgs/boost_roc.png" width="300"/>
...
<img src="imgs/stackingclassification_overview.png" width="400"/>


The image above summarizes the process:
...
<img src="imgs/stack_cm.png" width="300"/>
<img src="imgs/stack_hp.png" width="300"/>
<img src="imgs/stack_roc.png" width="300"/>
...
<img src="imgs/comparisons_all.png">
...
<img src="imgs/comparisons_corr.png">
...
<img src="imgs/comparisons_random.png">
